...
//        return response()->json(['data' => $avatar]);
        ...
        $nearestRestaurants = Restaurant::select("restaurants.id","restaurants.address","restaurants.image","restaurants.cover","restaurants.delivery_time","restaurants.delivery_fees"
