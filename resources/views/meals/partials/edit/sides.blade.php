    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" name="sides[name][]" value="{{ $side->name }}" placeholder="Name" />
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('price') is-invalid @enderror" name="sides[price][]" value="{{ $side->price }}" placeholder="Price" />
                <div class="invalid-feedback">
