    ...
    <div class="card-body">
       <form action="{{ route('subtags.update', [$tag->id , $subtag->id]) }}" method="post" class="row g-3 needs-validation" novalidate>
          ...
          <div class="col-md-12">
             ...
             <input type="text" name="name_ar" class="form-control @error('name_ar') is-invalid @enderror" value="{{ $subtag->name }}" id="validationCustom01" required>
          ...
          <div class="col-md-12">
            ...
            <input type="text" name="name_en" class="form-control @error('name_en') is-invalid @enderror" value="{{ $subtag->name }}" id="validationCustom01" required>
            <div class="invalid-feedback">
               Please provide a valid name.
            </div>
            @error('name_en')
         ...
         <div class="col-md-12">
            ...
            <input type="text" name="name_fr" class="form-control @error('name_fr') is-invalid @enderror" value="{{ $subtag->name }}" id="validationCustom01" required>
            <div class="invalid-feedback">
               Please provide a valid name.
            </div>
            @error('name_fr')
