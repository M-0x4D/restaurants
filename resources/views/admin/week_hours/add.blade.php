  ...
  <div class="mt-2 card form-card">
    <div class="card-header d-flex justify-content-between">
       <div class="header-title">
          <h4 class="card-title">Create New Week Hours</h4>
       </div>
    </div>
    <div class="card-body">
       <form action="{{ route('week_hours.store') }}" enctype="multipart/form-data" method="post" class="row g-3 needs-validation" novalidate>
          @csrf
          <div class="row">
           ...
           <div class="row">
               <div class="col-md-6">
                   ...
                   <input type="time" class="form-control @error('from') is-invalid @enderror" name="from">
                   <div class="invalid-feedback">
               ...
               <div class="col-md-6">
                   ...
                   <input type="time" class="form-control @error('to') is-invalid @enderror" name="to">
                   <div class="invalid-feedback">
                       Please provide a valid Date.
                   </div>
                   @error('to')
