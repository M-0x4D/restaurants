...
@section('content')
 ...
 <div class="container">
  ...
  <div class="mt-2 card">
    ...
    <div class="card-body">
       <form action="{{ route('offers.store') }}" enctype="multipart/form-data" method="post" class="row g-3 needs-validation" novalidate>
          @csrf
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="meal_id form-select @error('meal_id') is-invalid @enderror" name="meal_id" id="meal_id">
                    ...
                    {{-- <option selected>Select The Meal</option> --}}
          ...
          <div class="col-md-12">
            ...
            <input type="text" name="description_ar" class="form-control @error('description') is-invalid @enderror" id="validationCustom01" required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-12">
            ...
            <input type="text" name="description_en" class="form-control @error('description') is-invalid @enderror" id="validationCustom01" required>
            <div class="invalid-feedback">
               Please provide a valid description.
            </div>
            @error('description')
          ...
          <div class="col-md-12">
            ...
            <input type="text" name="description_fr" class="form-control @error('description') is-invalid @enderror" id="validationCustom01" required>
            <div class="invalid-feedback">
               Please provide a valid description.
            </div>
            @error('description')
         ...
         <div class="col-md-12">
            ...
            <input type="number" name="percentage" class="form-control @error('percentage') is-invalid @enderror" id="validationCustom01" required>
            <div class="invalid-feedback">
         ...
         <div class="col-md-12">
            ...
            <input type="date" name="from_date" class="form-control @error('from_date') is-invalid @enderror" id="validationCustom01" required>
            <div class="invalid-feedback">
         ...
         <div class="col-md-12">
            ...
            <input type="date" name="to_date" class="form-control @error('to_date') is-invalid @enderror" id="validationCustom01" required>
            <div class="invalid-feedback">
