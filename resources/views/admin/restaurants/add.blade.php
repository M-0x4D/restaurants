...
<div class="content-inner mt-5 py-0">
    <div class="row">
      <div class="col-sm-12">
         <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('restaurants.store') }}" enctype="multipart/form-data" id="form-wizard1" class="text-center mt-3">
                    @csrf
                        ...
                        <div class="form-card text-start">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror" name="name_ar" placeholder="Name" />
                                    <div class="invalid-feedback">
                                        Please provide a valid name.
                                     </div>
                                     @error('name_ar')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name_en') is-invalid @enderror" name="name_en" placeholder="Name" />
                                    <div class="invalid-feedback">
                                        Please provide a valid name.
                                     </div>
                                     @error('name_en')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name_fr') is-invalid @enderror" name="name_fr" placeholder="Name" />
                                    <div class="invalid-feedback">
                                        Please provide a valid name.
                                     </div>
                                     @error('name_fr')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('description_ar') is-invalid @enderror" name="description_ar" placeholder="Description" />
                                    <div class="invalid-feedback">
                                        Please provide a valid name.
                                     </div>
                                    @error('description')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('description_en') is-invalid @enderror" name="description_en" placeholder="Description" />
                                    <div class="invalid-feedback">
                                        Please provide a valid name.
                                     </div>
                                    @error('description')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('description_fr') is-invalid @enderror" name="description_fr" placeholder="Description" />
                                    <div class="invalid-feedback">
                                        Please provide a valid name.
                                     </div>
                                    @error('description')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('delivery_fees') is-invalid @enderror" name="delivery_fees" placeholder="Delivery Fees" />
                                    <div class="invalid-feedback">
                                        Please provide a valid name.
                                    </div>
                                    @error('delivery_fees')
                            ...
                            <div class="col-md-12">
                                ...
                                @foreach ($days as $day)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="time" class="form-control" id="from{{ $loop->iteration }}" name="weekhours[from][]" placeholder="From" />
                                        </div>

                                        <div class="col-md-3">
                                            <input type="time" class="form-control" id="to{{ $loop->iteration }}" name="weekhours[to][]" placeholder="To" />
                                        </div>
    ...
    <script>
        ...
        var marker = new google.maps.Marker({
            ...
            /*$(':checkbox').change(function(){
                ...
                $('#from'+this_nr).prop('disabled', $(this).is(':checked'));
                $('#to'+this_nr).prop('disabled', $(this).is(':checked'));
