<div class="row">
    ...
    <h2 class="text-start ms-2 mb-2">Best Meals</h2>

    {{-- @dd($restaurant->bestMeals) --}}
    @foreach ($restaurant->bestMeals as $meal)
        <div class="col-lg-6">
                    ...
                    <div class="d-flex justify-content-between pb-3 ">
                        <div>
                            ...
                            <div class="mt-4 mb-3">
                                ...
                                {{-- <span class="badge bg-soft-primary text-dark p-2">{{ $meal->tag->name }}</span> --}}
                            </div>
                            <p>{{ $meal->description }}</p>
                            <span class="text-dark">{{ $meal->price_value }}</span>
                        </div>
