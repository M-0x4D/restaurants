                    ...
                    <div class="swiper-slide">
                        <div class="card card-white dish-card profile-img mb-0">
                            <div class="profile-img21">
                                <img src="{{ $meal->img_path }}" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                    alt="profile-image">
                                <img src="{{ $meal->img_path }}" class="img-fluid rounded-pill avatar-170 hover-image " alt="profile-image"
                            ...
                            <h6 class="heading-title fw-bolder mt-4 mb-0">{{ $meal->name }}</h6>
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    <div class="d-flex align-items-center">
                                        <span class="text-primary fw-bolder me-2">{{ $meal->price_value }}</span>
                                    </div>
