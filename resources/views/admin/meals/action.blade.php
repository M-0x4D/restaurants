<a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ route('meals.edit', [$restaurant_id, $id]) }}">
...
<a class="btn btn-sm btn-icon btn-info" data-toggle="tooltip" data-placement="top" title="" data-original-title="Upload" href="{{ route('meals.upload', [$restaurant_id, $id]) }}">
    <span class="btn-inner">
...
<a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="{{ route('meals.delete', [$restaurant_id, $id]) }}">
    <span class="btn-inner">
