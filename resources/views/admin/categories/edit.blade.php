  ...
  <div class="mt-2 card">
    <div class="card-header d-flex justify-content-between">
       <div class="header-title">
          <h4 class="card-title">Update Category {{ $category[0]->name }}</h4>
       </div>
    </div>
    <div class="card-body">
       <form action="{{ route('categories.update', $category[0]->category_id) }}" enctype="multipart/form-data" method="post" class="row g-3 needs-validation" novalidate>
          @method('PUT')
          @csrf
          <div class="col-md-12">
             <label for="validationCustom01" class="form-label">name ar</label>
             <input type="text" name="name_ar" class="form-control @error('name_ar') is-invalid @enderror" value="{{ $category[0]->name }}" id="validationCustom01" required>
          ...
          <div class="col-md-12">
             ...
             <input type="text" name="name_en" class="form-control @error('name_en') is-invalid @enderror" value="{{ $category[1]->name }}" id="validationCustom01" required>
             <div class="invalid-feedback">
                Please provide a valid name.
             </div>
             @error('name_en')
          ...
          <div class="col-md-12">
             ...
             <input type="text" name="name_fr" class="form-control @error('name_fr') is-invalid @enderror" value="{{ $category[2]->name }}" id="validationCustom01" required>
             <div class="invalid-feedback">
                Please provide a valid name.
             </div>
             @error('name_fr')
          ...
          <div class="col-md-12">
            ...
            @enderror
            <img width="150" src="{{ $category[0]->img_path }}" alt="" srcset="">
         </div>
         <div class="col-md-12">
            <label for="validationCustom03" class="form-label">color</label>
            <input type="text" class="form-control @error('color') is-invalid @enderror" name="color" value="{{ $category[0]->color }}">
            <div class="invalid-feedback">
         ...
         <div class="col-md-12">
            ...
            <input type="text" class="form-control @error('border_color') is-invalid @enderror" name="border_color" value="{{ $category[0]->border_color }}">
            <div class="invalid-feedback">
