...
@section('content')
    <div class="container">
        ...
        <div class="mt-2 card form-card">
            ...
            <div class="card-body">
                <form action="{{ route('coupons.update' , $coupon->id) }}" enctype="multipart/form-data" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <select name="restaurant_id"  onchange="getSubTags(this)" class="form-select" id="exampleFormControlSelect1"
                            ...
                            @foreach ($restaurants as $restaurant)
                                <option value="{{ $restaurant->id }}" @if($coupon->restaurant_id == $restaurant->id) selected @endif>{{ $restaurant->name }}</option>
                            @endforeach
                    ...
                    <div class="col-md-12">
                        ...
                        <input value="{{$coupon->code}}" type="text" name="code" class="form-control @error('name') is-invalid @enderror"
                    ...
                    <div class="col-md-12">
                        ...
                        <input value="{{$coupon->discount_percentage}}"  type="text" name="discount_percentage" class="form-control @error('discount_percentage') is-invalid @enderror"
                               id="validationCustom01" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-12">
                        ...
                        <input value="{{$coupon->available_users}}" type="text" name="available_users" class="form-control @error('available_users') is-invalid @enderror"
                               id="validationCustom01" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-12">
                        ...
                        <input value="{{$coupon->used_count}}" type="text" name="used_count" class="form-control @error('used_count') is-invalid @enderror"
                               id="validationCustom01" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-12">
                        ...
                        <input value="{{$coupon->start_date}}" type="date" name="start_date" class="form-control @error('start_date') is-invalid @enderror" id="validationCustom01" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-12">
                        ...
                        <input value="{{$coupon->expire_date}}" type="date" name="expire_date" class="form-control @error('expire_date') is-invalid @enderror" id="validationCustom01" required>
                        <div class="invalid-feedback">
